...
const Navbar = () => {
  ...
  return (
    <div style={{ backgroundColor: `${navBg}` }} className={shadow ? 'w-full h-20 fixed z-[99999] shadow-md lg:text-xl' : 'w-full h-20 fixed z-[9999] lg:text-xl'}>
      <div className="w-full h-full flex justify-between items-center px-4 md:px-16">
        <Image src="/../public/assets/logo.png" alt="Logo" width="90" height="50" />
        <div>
          <ul style={{ color: `${linkColor}` }} className="hidden  md:flex gap-x-8">
            <Link href="/#home">
              <li className="text-sm hover:text-gray-600 transition">HOME</li>
            </Link>
            <Link href="/#about">
              <li className="text-sm hover:text-gray-600 transition">ABOUT</li>
            </Link>
            <Link href="/#skills">
              <li className="text-sm hover:text-gray-600 transition">SKILLS</li>
            </Link>
            <Link href="/#project">
              <li className="text-sm hover:text-gray-600 transition">PROJECT</li>
            </Link>
            <Link href="/#contact">
              <li className="text-sm hover:text-gray-600 transition">CONTACT</li>
            </Link>
          </ul>
      ...
      <div className={!nav ? 'md:hidden fixed top-0 left-0 w-full h-screen bg-black/50' : ''}>
        {/* Navbar Menu */}
        <div className={!nav ? 'md:hidden fixed top-0 left-0 h-screen bg-white w-4/5 md:w-1/3 p-8 transition ease-in duration-300' : 'fixed top-0 left-[-100%] ease-in duration-500'}>
          <div className="w-full flex items-center justify-between">
            <Image src="/../public/assets/logo.png" alt="Logo" width="80" height="0" />
            <div onClick={handleNav} className="rounded-full shadow-lg shadow-gray-400/60 p-2 group cursor-pointer">
          ...
          <div className="flex flex-col py-4">
            <ul>
              <Link href="/#home">
                <li onClick={handleNav} className="text-sm py-4 uppercase hover:text-gray-600 transition">
                  Home
                </li>
              </Link>
              <Link href="/#about">
