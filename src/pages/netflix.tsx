  ...
  return (
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[80vh] relative">
        ...
        <Image className="absolute -z-10" layout="fill" objectFit="cover" src={netflixImg} alt="/" />
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-slate-100 p-2 lg:p-4">
          <h2 className="py-2 lg:text-4xl">Netflix UI</h2>
      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-8 gap-8 pt-8 p-2">
        <div className="col-span-4 md:col-span-6">
          ...
          <p className="text-gray-600 text-sm lg:text-base">
            I built this application in React JS and is hosted on GitHub pages. This app features user authentication with firebase as well as the firestore cloud storage database. This application is pulling movie data from an the IMDB
            movie API and displaying different categories. It features horizontal sliding and a featured selection. The useContext hook is also being implemented for app-wide state management.
          </p>
